...
## Environments
- Preview: https://main--ueworkshop--syamavarm.hlx.page/
- Live: https://main--ueworkshop--syamavarm.hlx.live/
...
1. Open the `ueworkshop` directory in your favorite IDE and start coding :)
